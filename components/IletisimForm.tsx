...
export default function IletisimForm({ corporate = false, initialService = "" }: { corporate?: boolean; initialService?: string }) {
    const safeInitialService = corporateServices.some((service) => service.shortTitle === initialService) ? initialService : "";
    ...
    async function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        if (loading) return;
        if (!form.consent) { setError("Formu göndermek için KVKK aydınlatma metnini okuyup onaylamalısınız."); return; }
