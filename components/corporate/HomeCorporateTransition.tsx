        ...
        <div className="mx-auto grid min-w-0 max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,.95fr)] lg:items-center lg:px-8">
            <div className="min-w-0">
                ...
                <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                    ...
                    <Link href="/kurumsal/rehber" className="inline-flex min-h-11 items-center justify-center rounded-xl px-4 py-2.5 text-sm font-bold text-slate-700 underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-orange-200 dark:text-slate-200">Karar rehberlerini okuyun</Link>
                </div>
            </div>
